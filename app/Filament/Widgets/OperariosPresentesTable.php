    ...
    return $table
        ->query(
            Ingreso::query()
                ...
                ->with(['operario', 'solicitante.sector']) // ← CAMBIAR: agregar .sector
        )
        ->columns([
            ...
            Tables\Columns\TextColumn::make('solicitante.sector.nombre') // ← CAMBIAR
                ->label('Sector')
                ->sortable()
                ->searchable(),
        ...
        ->defaultSort('solicitante.sector.nombre'); // ← CAMBIAR
}
}
